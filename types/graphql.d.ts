...
export type CreateNewProjectMutation = { __typename?: 'Mutation', createProject?: { __typename?: 'ProjectCreateMutation', response?: boolean | null, message?: string | null, projectInstance?: { __typename?: 'ProjectType', id: string } | null } | null };
...
export type CreateNewCommentMutation = { __typename?: 'Mutation', createComment?: { __typename?: 'CommentCreateMutation', response?: boolean | null, message?: string | null } | null };

export type GetAllTagsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllTagsQuery = { __typename?: 'Query', allTag?: Array<{ __typename?: 'TagType', id: string, tagName: string } | null> | null };
...
export type GetFilteredTagsQuery = { __typename?: 'Query', filterTag?: Array<{ __typename?: 'TagType', id: string, tagName: string } | null> | null };

export type GetAllProjectsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllProjectsQuery = { __typename?: 'Query', allProject?: Array<{ __typename?: 'ProjectType', id: string, logo: string, name: string, subtitle: string, postedAt: any, upvote: number, tag: Array<{ __typename?: 'TagType', tagName: string }>, comments: Array<{ __typename?: 'CommentType', id: string }> } | null> | null };
...
export type ProjectByIdQuery = { __typename?: 'Query', projectById?: { __typename?: 'ProjectType', logo: string, id: string, name: string, subtitle: string, postedAt: any, description: string, upvote: number, owner: { __typename?: 'ProfileType', id: string, username: string, avatar: string }, tag: Array<{ __typename?: 'TagType', tagName: string }> } | null };
...
export type ProjectByIdCommentsQuery = { __typename?: 'Query', projectById?: { __typename?: 'ProjectType', comments: Array<{ __typename?: 'CommentType', id: string, comment: string, date: any, owner: { __typename?: 'ProfileType', id: string, username: string, avatar: string }, replies: Array<{ __typename?: 'ReplyType', id: string, reply: string, date: any, owner: { __typename?: 'ProfileType', id: string, username: string, avatar: string } }> }> } | null };
